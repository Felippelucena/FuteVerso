...
const WEIGHTS: Record<PlayerPosition, SkillWeights> = {
  ...
  centerBack: { defending: 4, strength: 2, kickPower: 1.2, control: 1, passing: 1.2, sprintSpeed: 1.2, stamina: 1, acceleration: 1 },
  rightBack: { defending: 2.6, sprintSpeed: 2, stamina: 2, acceleration: 1.8, passing: 1.4, control: 1.2, strength: 1, vision: 0.8 },
  leftBack: { defending: 2.6, sprintSpeed: 2, stamina: 2, acceleration: 1.8, passing: 1.4, control: 1.2, strength: 1, vision: 0.8 },
  defensiveMid: { defending: 3, passing: 2.2, stamina: 2, vision: 1.6, strength: 1.6, control: 1.4, kickPower: 0.8 },
  centerMid: { passing: 2.8, vision: 2.6, control: 2.2, stamina: 1.8, defending: 1.4, strength: 1, finishing: 0.8 },
  ...
  striker: { finishing: 4, control: 2, burst: 1.8, strength: 1.8, acceleration: 1.6, kickPower: 1.4, sprintSpeed: 1.2 },
};
